              ...
              <div className="column  is-4 is-offset-1">
                <Link to="#">
                  <div className="field is-grouped is-grouped-multiline">
                    ...
                    <div className="control">
                      <div className="tags has-addons">
                        <span className="tag is-primary">S{post.frontmatter.series}</span>
                        <span className="tag is-dark">E{post.frontmatter.episode}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="field is-grouped">
                    ...
                    <div className="control">
                      <div className="tags">
                        <span className="tag is-dark">{post.frontmatter.date}</span>
                      </div>
                    </div>
                  </div>
                </Link>
